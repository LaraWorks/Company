                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-5 @error('technology') is-invalid @enderror" name="technology" id="Input2">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-5 @error('service') is-invalid @enderror" name="service" id="Input2">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-5 @error('date') is-invalid @enderror" name="date" id="Input2">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select rounded-5 @error('items') is-invalid @enderror" name="items[]" id="Select1" aria-label="Default select example">
